...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/quotes/adminLTE/plugins/pace/pace.min.css">
</head>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="http://localhost/quotes/adminLTE/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="http://localhost/quotes/adminLTE/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="http://localhost/quotes/adminLTE/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
...
<link rel="stylesheet" type="text/css" href="../css/custom.css">
  ...
  <!-- /.content-wrapper -->
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016 <a href="http://localhost/quotes">ilovequotes</a>.</strong> All rights
        reserved.
      </footer>
      <?php 
        include('aside.php');
    ...
    <script src="http://localhost/quotes/adminLTE/plugins/jQuery/jquery-2.2.3.min.js"></script>
    <script src="http://localhost/quotes/adminLTE/plugins/jQueryUI/jquery-ui.min.js"></script>
    <script>
      $.widget.bridge('uibutton', $.ui.button);
    </script>
    <script type="text/javascript" src="http://localhost/quotes/adminLTE/bootstrap/js/bootstrap.min.js"></script>
    ...
    <script type="text/javascript" src="http://localhost/quotes/adminLTE/plugins/sparkline/jquery.sparkline.min.js"></script>
    ...
    <script type="text/javascript" src="http://localhost/quotes/adminLTE/plugins/knob/jquery.knob.js"></script>
    <script type="text/javascript" src="http://localhost/quotes/adminLTE/plugins/daterangepicker/moment.min.js"></script>
    <script type="text/javascript" src="http://localhost/quotes/adminLTE/plugins/daterangepicker/daterangepicker.js"></script>
    ...
    <script type="text/javascript" src="http://localhost/quotes/adminLTE/plugins/slimScroll/jquery.slimscroll.min.js"></script>
    <script type="text/javascript" src="http://localhost/quotes/adminLTE/plugins/fastclick/fastclick.min.js"></script>
    ...
    <script src="http://localhost/quotes/adminLTE/plugins/pace/pace.min.js"></script>
